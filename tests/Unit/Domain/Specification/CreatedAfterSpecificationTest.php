...
final class CreatedAfterSpecificationTest extends TestCase
{
    public function testIsSatisfiedByDocumentCreatedAfterDate(): void
    {
        // Arrange
        ...
        $spec = new CreatedAfterSpecification(new \DateTimeImmutable('2024-11-01'));

        // Act & Assert
        $this->assertTrue($spec->isSatisfiedBy($document));
    }

    public function testIsNotSatisfiedByDocumentCreatedBeforeDate(): void
    {
        // Arrange
        $user = new User('Alice', 'alice@example.com');
        $document = new Document(
            ...
            fileSize: 1024,
            tags: [],
            createdAt: new \DateTimeImmutable('2024-10-01')
        );
    ...
    public function testIsSatisfiedByDocumentCreatedOnExactDate(): void
    {
        ...
        $spec = new CreatedAfterSpecification($date);
